...
const SpotlightAnimation: React.FC = () => {
  return (
    <div id="bg-wrap" className="absolute opacity-10 inset-0 w-full h-full overflow-hidden">
      <svg
        viewBox="0 0 100 100"
      ...
      >
        <defs>
          ...
          <radialGradient id="Gradient5" cx="50%" cy="50%" fx="2.65405%" fy="50%" r="0.5">
          ...
          <radialGradient id="Gradient6" cx="50%" cy="50%" fx="0.981338%" fy="50%" r="0.5">
